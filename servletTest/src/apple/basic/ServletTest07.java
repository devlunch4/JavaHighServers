...
public class ServletTest07 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// Web.xml 파일의 <web-app>엘리먼트 바로 아래의 자식 엘리먼트로 <context-param> 이라는 이름으로 작성한다

		// 이 <context-param>엘리먼트는 <param-name>과 <param-value>의 자식 엘리먼트가 있다.

		// Servlet 클래스에서는 getServletContext()메서드를 이용해서 servletContext 객체를 구하고,
		// 이 객체의 getInitParameter()메서드를 호출하여 사용한다.
		...
		out.println("<body>");
		out.println("<h2>CONTEXT 파라미터</h2>");
