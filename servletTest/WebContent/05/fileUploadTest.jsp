...
<body>
	...
	<h3>
		파일 선택창에서 ctrl키나 shift 키를 누를 상태에서 클릭을 하면 <br> 여러개의 파일을 한꺼번에 선택할 수
		있다.
	</h3>
	...
	<form action="<%=request.getContextPath()%>/fileUploadServlet.do"
		...
		Upload File1 : <input type="file" name="file1" multiple><br>
	...
	<a href="<%=request.getContextPath()%>/uploadedFilesServlet.do">전체
		업로드된 파일 목록 가져오기</a>
</body>
</html>